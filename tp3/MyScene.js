...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.constPrism = new MyPrism(this,8,20);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(r,g,b,1.0);
        this.material4.setDiffuse(r*dRate,g*dRate,b*dRate,1.0);
        this.material4.setSpecular(r*sRate,g*sRate,b*sRate,1.0);
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2,'Wodden Material':3 , 'Custom': 4 };
    }
    display() {
...
/*         
        ...
        if (this.displayNormals)
            this.constPrism.enableNormalViz();
        else
            this.constPrism.disableNormalViz();
        this.rotate(-Math.PI/2,1,0,0);
        this.constPrism.display();
