...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'objectComplexity', 3, 10).step(1).onChange(this.scene.updateObjectComplexity.bind(this.scene));

        this.gui.add(this.scene, 'selectedMaterial', this.scene.materialIDs).name('Selected Material');
        this.gui.add(this.scene,'ambientIntensity',0.1,1.0).name('Ambient Intensity');
